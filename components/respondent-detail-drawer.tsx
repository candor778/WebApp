...
export function RespondentDetailDrawer({ respondent, surveyId, open, onOpenChange }: RespondentDetailDrawerProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl max-h-[85vh] p-0">
        <DialogHeader className="px-6 pt-6 pb-4">
          ...
          <DialogDescription className="font-mono text-xs">ID: {respondent.id}</DialogDescription>
        </DialogHeader>
        ...
        <ScrollArea className="max-h-[calc(85vh-100px)] px-6 pb-6">
          <div className="space-y-6">
              ...
              <div className="grid gap-2 text-sm">
                <div className="flex items-center gap-3 p-2 rounded-md bg-muted/50">
                  ...
                  <div>
                    ...
                    <p className="font-mono">{respondent.userId || respondent.respondentName}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <p>
                      {respondent.browserName
                        ? respondent.browserName.charAt(0) + respondent.browserName.slice(1).toLowerCase()
                        : "Unknown"}{" "}
                      on{" "}
                ...
                <div className="flex items-center gap-3 p-2 rounded-md bg-muted/50">
                  ...
                  <div>
                    ...
                    <p className="font-mono text-xs">{respondent.ipAddress || "Unknown"}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 rounded-lg bg-muted/50 text-sm text-muted-foreground">
              <p>This system captures metadata only. Survey answers are collected by the external survey tool.</p>
            </div>
          </div>
        </ScrollArea>
      </DialogContent>

...
export function DeleteProjectButton({ id }: { id: string }) {
  ...
  // Stop propagation to prevent card click from navigating
      ...
      <AlertDialog open={open} onOpenChange={handleOpenChange}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete the project and all associated responses.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="my-4">
